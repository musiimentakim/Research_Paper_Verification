<nav id="sidebar" class="sidebar js-sidebar">
  <div class="sidebar-content js-simplebar">
    <a class="sidebar-brand" href="./index.php">
      <span class="align-middle">Publication Sure</span>
    </a>
  ...
  <li class="sidebar-item">
    <a class="sidebar-link" href="./validate.php">
        <i class="align-middle" data-feather="check-circle"></i>
        <span class="align-middle">Validate Paper</span>
    </a>
  </li>
  ...
  <li class="sidebar-item">
    <a class="sidebar-link" href="./subscription.php">
  ...
  <li class="sidebar-item">
    <a class="sidebar-link" href="./Components/logout.php">
